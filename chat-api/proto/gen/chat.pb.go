...
type ChatMessage struct {
	...
	IsDelivered   bool                   `protobuf:"varint,7,opt,name=is_delivered,json=isDelivered,proto3" json:"is_delivered,omitempty"`
...
const file_chat_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"chat.proto\x12\x06chatpb\"\xcd\x02\n" +
	...
	"\fdelivered_at\x18\x06 \x01(\tR\vdeliveredAt\x12!\n" +
	"\fis_delivered\x18\a \x01(\bR\visDelivered\x12\x19\n" +
	"\bfile_url\x18\b \x01(\tR\afileUrl\x12\x1b\n" +
	"\tfile_type\x18\t \x01(\tR\bfileType\x12\x1b\n" +
	"\tfile_name\x18\n" +
	" \x01(\tR\bfileName\x12\x19\n" +
	"\bis_group\x18\v \x01(\bR\aisGroup\"i\n" +
	...
	"\bmessages\x18\x01 \x03(\v2\x13.chatpb.ChatMessageR\bmessages\"o\n" +
	"\x05Group\x12\x0e\n" +
	...
	"\amembers\x18\x04 \x03(\tR\amembers\"H\n" +
	...
	"\amembers\x18\x01 \x03(\tR\amembers\"T\n" +
	...
	"\x06status\x18\x01 \x01(\tR\x06status2\xd9\x05\n" +
	"\vChatService\x12;\n" +
	"\vSendMessage\x12\x13.chatpb.ChatMessage\x1a\x13.chatpb.ChatMessage(\x010\x01\x12B\n" +
	"\x10SendTypingStatus\x12\x14.chatpb.TypingStatus\x1a\x14.chatpb.TypingStatus(\x010\x01\x12<\n" +
	"\x0fSendMessageRest\x12\x13.chatpb.ChatMessage\x1a\x14.chatpb.SendResponse\x12E\n" +
	"\n" +
	"GetHistory\x12\x1a.chatpb.ChatHistoryRequest\x1a\x1b.chatpb.ChatHistoryResponse\x124\n" +
	"\vCreateGroup\x12\r.chatpb.Group\x1a\x16.chatpb.SimpleResponse\x12D\n" +
	"\x0eAddGroupMember\x12\x1a.chatpb.GroupMemberRequest\x1a\x16.chatpb.SimpleResponse\x12G\n" +
	"\x11RemoveGroupMember\x12\x1a.chatpb.GroupMemberRequest\x1a\x16.chatpb.SimpleResponse\x12@\n" +
	"\x0fGetGroupMembers\x12\x0f.chatpb.GroupID\x1a\x1c.chatpb.GroupMembersResponse\x12A\n" +
	"\vEditMessage\x12\x1a.chatpb.EditMessageRequest\x1a\x16.chatpb.SimpleResponse\x12E\n" +
	"\rDeleteMessage\x12\x1c.chatpb.DeleteMessageRequest\x1a\x16.chatpb.SimpleResponse\x123\n" +
	"\x04Init\x12\x13.chatpb.UserRequest\x1a\x16.chatpb.StatusResponseB\x14Z\x12chat-api/proto/genb\x06proto3"
...
var file_chat_proto_goTypes = []any{
	...
	(*SendResponse)(nil),         // 2: chatpb.SendResponse
	(*ChatHistoryRequest)(nil),   // 3: chatpb.ChatHistoryRequest
	(*ChatHistoryResponse)(nil),  // 4: chatpb.ChatHistoryResponse
	(*Group)(nil),                // 5: chatpb.Group
	(*GroupMemberRequest)(nil),   // 6: chatpb.GroupMemberRequest
	(*GroupID)(nil),              // 7: chatpb.GroupID
	(*GroupMembersResponse)(nil), // 8: chatpb.GroupMembersResponse
	(*EditMessageRequest)(nil),   // 9: chatpb.EditMessageRequest
	(*DeleteMessageRequest)(nil), // 10: chatpb.DeleteMessageRequest
	(*SimpleResponse)(nil),       // 11: chatpb.SimpleResponse
...
var file_chat_proto_depIdxs = []int32{
	...
	0,  // 1: chatpb.ChatService.SendMessage:input_type -> chatpb.ChatMessage
	1,  // 2: chatpb.ChatService.SendTypingStatus:input_type -> chatpb.TypingStatus
	0,  // 3: chatpb.ChatService.SendMessageRest:input_type -> chatpb.ChatMessage
	3,  // 4: chatpb.ChatService.GetHistory:input_type -> chatpb.ChatHistoryRequest
	5,  // 5: chatpb.ChatService.CreateGroup:input_type -> chatpb.Group
	6,  // 6: chatpb.ChatService.AddGroupMember:input_type -> chatpb.GroupMemberRequest
	6,  // 7: chatpb.ChatService.RemoveGroupMember:input_type -> chatpb.GroupMemberRequest
	7,  // 8: chatpb.ChatService.GetGroupMembers:input_type -> chatpb.GroupID
	9,  // 9: chatpb.ChatService.EditMessage:input_type -> chatpb.EditMessageRequest
	10, // 10: chatpb.ChatService.DeleteMessage:input_type -> chatpb.DeleteMessageRequest
	12, // 11: chatpb.ChatService.Init:input_type -> chatpb.UserRequest
	0,  // 12: chatpb.ChatService.SendMessage:output_type -> chatpb.ChatMessage
	1,  // 13: chatpb.ChatService.SendTypingStatus:output_type -> chatpb.TypingStatus
	2,  // 14: chatpb.ChatService.SendMessageRest:output_type -> chatpb.SendResponse
	4,  // 15: chatpb.ChatService.GetHistory:output_type -> chatpb.ChatHistoryResponse
	11, // 16: chatpb.ChatService.CreateGroup:output_type -> chatpb.SimpleResponse
	11, // 17: chatpb.ChatService.AddGroupMember:output_type -> chatpb.SimpleResponse
	11, // 18: chatpb.ChatService.RemoveGroupMember:output_type -> chatpb.SimpleResponse
	8,  // 19: chatpb.ChatService.GetGroupMembers:output_type -> chatpb.GroupMembersResponse
	11, // 20: chatpb.ChatService.EditMessage:output_type -> chatpb.SimpleResponse
	11, // 21: chatpb.ChatService.DeleteMessage:output_type -> chatpb.SimpleResponse
